...
import { useSidebar, SidebarContext, SidebarContextI } from "./context/sidebar-context"
      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex w-full min-h-screen has-[[data-variant=inset]]:bg-sidebar",
              className
            )}
            ref={ref}
            {...props}
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-screen h-full flex-1 flex-col bg-sidebar dark:bg-sidebar",
