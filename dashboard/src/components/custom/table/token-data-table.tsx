...
import TokenColumns from "@/components/custom/column/token-columns"
...
import { TokenDataTableProps } from "@/interface/blockchain"
import { DataTableSkeleton } from "@/components/custom/layout/skeletons"

export function TokenDataTable({ tokens, networks, onNavigate, loading, itemsPerPage }: TokenDataTableProps) {
